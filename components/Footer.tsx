...
import { firebaseApp } from '@/firebase/firebaseConfig';  // Adjust the import to your actual Firebase config file
import { addSubscriber } from '@/utils/userNewsletterSubscription';  // Adjust the import to your actual file path
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-black-200 text-white pt-10 mt-10 lg:px-6 lg:mt-20 border-t border-gray-800">
