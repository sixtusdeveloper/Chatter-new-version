...
const Notification: React.FC<{ isMobile?: boolean }> = ({ isMobile = false }) => {
        ...
        <div className="absolute right-0 top-12 p-2 mt-2 w-80 border border-gray-700 bg-gray-800 shadow rounded-lg max-h-64 overflow-y-auto no-scrollbar">
          ...
          <ul>
            {notifications.map((notification) => (
              <li
                key={notification.id}
                className="border-b p-4 border-gray-700 text-sm cursor-pointer text-gray-400"
              >
...
//   return (
//     <div className="relative sm:px-6 flex justify-end p-2">
//       <button
