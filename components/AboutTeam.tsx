    ...
    <>
      <SignedIn>
        <section className="relative bg-black-200 py-8">
          ...
          <div className="relative mx-auto max-w-7xl px-6 lg:px-10 z-10" id="team">
                ...
                >
                  ...
                  <div className="flex flex-col justify-start">
                    ...
                    <p className="text-gray-400 mt-2 text-sm">
                      ...
                      <a
                        href={
                          member.id === 1 ? `/team/dev-one/${member.id}` :
                          member.id === 2 ? `/team/dev-two/${member.id}` :
                          `/team/dev-three/${member.id}`
                        }
...
//                   {truncateDescription(member.description, MAX_DESCRIPTION_LENGTH)}
//                   <a
//                     href={`/pages/team/dev-one/${member.id}`} // Update the link to the member's full profile or details
//                     className="text-purple hover:text-purple-600 inline-flex items-center mt-2"
//                   >
//                     Read more <GoArrowRight className="text-purple text-lg ml-1" />
//                   </a>
