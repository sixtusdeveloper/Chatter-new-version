...
const SocialIcons: React.FC<SocialIconsProps> = ({ role }) => (
  <div className="flex justify-start items-center mt-4 gap-8">
    <div className='flex space-x-4 bg-transparent rounded-full py-2 px-4 border border-gray-800'>
    ...
    <div className='flex items-center bg-transparent py-2 px-4 rounded-full border border-gray-800'>
