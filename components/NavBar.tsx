  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-40 transition-colors duration-500 ${
        scrolling ? 'bg-black-100' : 'bg-transparent'
      }`}
    >
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          {navigation.map((item) => (
            <a
              ...
              className={`text-sm font-semibold leading-6 tracking-wider ${
                activeSection === item.href.substring(1) ? 'text-blue-300' : 'text-blue-100'
              } hover:text-blue-200`}
