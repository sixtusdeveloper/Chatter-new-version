...
const SearchFilterSection = () => {
  ...
  return (
    <section className="bg-black-200 relative md:pt-10 mx-auto max-w-7xl px-6 lg:px-8 border-b border-gray-800 pb-20">
      ...
      <div className="container mx-auto max-w-4xl px-6 flex flex-col lg:flex-row justify-between items-center">
        <div className="flex-grow mb-4 lg:mb-0 w-full lg:w-auto">
          <input
            ...
            className="w-full px-4 md:py-3 py-2 border border-gray-800 rounded-full bg-black-200 text-white md:w-80 lg:w-full"
          />
        </div>
      </div>
    </section>
