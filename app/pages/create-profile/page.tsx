...
// const CreateProfile = ({ postId }: { postId: string }) => {
...
//           <div className="absolute inset-0 flex items-center justify-center top-0 left-0">
...
//               Create<span className="text-purple">&nbsp;Profile</span>
//             </h2>
...
//               )}
//             </h3>
//             <p className='text-center text-[1rem] p-8 font-semibold tracking-wide'>Fill out all the input fields below to setup your profile</p>
//             <form onSubmit={handleSubmit} className="bg-gray-900 p-12 lg:p-8 rounded-lg max-w-2xl mx-auto overflow-x-hidden">
...
//                 </div>
//                 <div className="mb-6">
//                     <label htmlFor="biography" className="block text-gray-200 text-[0.88rem] tracking-wide mb-2">Personal Biography</label>
//                     <textarea
//                     id="biography"
//                     value={biography}
...
//                 <div className="mb-6">
//                     <label htmlFor="profileImage" className="block text-gray-200 text-[0.88rem] tracking-wide mb-2">Profile Image</label>
//                     <input
//                     id="profileImage"
//                     type="file"
//                     onChange={handleAvatarUpload}
//                     className="w-full text-gray-100 text-[0.88rem] tracking-wide"
//                     />
//                 </div>
//                 <button
//                     type="submit"
          ...
          <div className="container mx-auto px-0 lg:px-6 z-10 relative overflow-x-hidden">
            ...
            <form onSubmit={handleSubmit} className="bg-gray-900 p-4 lg:p-8 rounded-lg max-w-2xl mx-auto overflow-x-hidden">
                ...
                <div className="flex justify-end space-x-4">
                    <button
                        type="submit"
                        className="w-full bg-blue-600 hover:bg-blue-500 text-white p-2 lg:p-3 rounded-md text-[0.88rem] tracking-wide"
                        >
                        Create Profile
                    </button>
                </div>
